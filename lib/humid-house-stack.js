...
const RASPBERRY_PI_S01_PRINCIPAL_ATTACHEMENT_ID = `${RASPBERRY_PI_S01}principalattachement`;
...
class HumidHouseStack extends cdk.Stack {
  ...
  async _createCertificate() {
    ...
    new iot.CfnThingPrincipalAttachment(this, RASPBERRY_PI_S01_PRINCIPAL_ATTACHEMENT_ID, {
      thingName: {
